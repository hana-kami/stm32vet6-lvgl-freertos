 ...
 * 注：根据实际屏幕规格调整
 ***************************************************************************************/
#define      macGC9B71_Default_Max_Width		  200     // 默认显示宽度
#define      macGC9B71_Default_Max_Heigth		480     // 默认显示高度
...
#define      macGC9B71_DispWindow_COLUMN		    200   // 显示窗口列数（宽度）
#define      macGC9B71_DispWindow_PAGE		      480   // 显示窗口页数（高度）
